...
原始错误信息：
```
插件 'OneClick JavaBean Generator' (版本 '1.3-SNAPSHOT')与当前版本的 IDE 不兼容，
...
### 如果您的IDEA版本兼容
1. 下载最新的插件文件：`OneClick-1.3-SNAPSHOT.zip`
2. 在IDEA中安装：
...
| 日期 | 版本 | 变更 |
|------|------|------|
| 2025-09-28 | 1.3-SNAPSHOT | 修复版本兼容性，支持到2025.3 |
| 2025-09-28 | 1.3-SNAPSHOT | 初始版本，支持到2024.2 |
